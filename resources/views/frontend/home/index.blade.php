                        ...
                        @foreach($service_items as $item)
                            <div class="swiper-slide">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--image">
                                            <a href="service-details.html" class="wptb-item-link"><img src="{{ asset('public/backend/page/'.$item->thumbnail) }}" alt="img"></a>
                                        </div>
                                        <div class="wptb-item--holder">
                                            ...
                                            <div class="wptb-item--button">
                                                <a class="btn--readmore" href="{{ route('front.page-details', [$item->id]) }}">
                    ...
                    @foreach($blog_items as $item)
                        ...
                        <div class="col-sm-6">
                            <div class="wptb-blog-grid1 active highlight wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        <a href="{{ route('front.blog-details',[$item->id]) }}" class="wptb-item-link"><img src="{{ asset('public/backend/blog/'.$item->thumbnail) }}" alt="img"></a>
                                    </div>
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--meta">
                                        ...
                                        <h5 class="wptb-item--title"><a href="{{ route('front.blog-details',[$item->id]) }}">{{ $item->title }}</a></h5>
                                        <p class="wptb-item--description">{!!Str::limit($item->description, 70) !!}</p>
                                        
                                        <div class="wptb-item--button"> 
                                            <a class="btn--readmore" href="{{ route('front.blog-details',[$item->id]) }}"> 
