                    ...
                    <div class="footer-upper-contact">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 mb-4 mb-sm-0">
                                <div class="logo">
                                    <a href="index.html" class="light_logo"><img src="{{ getImage('settings',getInfo('logo'))}}" alt="logo"></a>
                                </div>
                            </div>
                                ...
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">{{ getInfo('address') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-sm-6 mb-4 mb-sm-0">
                                <div class="wptb-icon-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner flex-start">
                                        ...
                                        <div class="wptb-item--holder">
                                            <p class="wptb-item--description">{{ getInfo('contact') }}</p>
                                            <p class="wptb-item--description">{{ getInfo('contact') }}</p>
                                        </div>
                                    </div>
                                </div> 
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-inner">
                        <div class="copyright">
                            <p>&copy;Copyright 2024 <a href="{{ route('front.home') }}">Visa</a>. All rights reserved</p>
                        </div>
